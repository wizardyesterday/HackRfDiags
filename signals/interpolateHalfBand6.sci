...
// an input signal, that is sampled at 512000S/s can be
// interpolated to 1024000S/s.  We want to limit the bandwidth of
...
title("Antialiasing Filter - Sample Rate: 1024000 S/s  (interpolated)");
a = gca();
