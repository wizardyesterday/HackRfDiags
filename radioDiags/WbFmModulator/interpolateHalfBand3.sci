...
// an input signal, that is sampled at 64000 S/s can be
// interpolated to 128000/s.  We want to limit the bandwidth of
// the imaging filter to 13600 Hz.  The filter coefficients are
...
// Pass Band: 0 <= F <= 13600 Hz.
// Transition Band: 13600 < F <= 50400 Hz.
// Stop Band: 50400 < F < 64000 Hz.
...
title("Antialiasing Filter - Sample Rate: 128000 S/s  (interpolated)");
a = gca();
