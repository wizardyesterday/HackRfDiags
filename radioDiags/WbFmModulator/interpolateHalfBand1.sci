...
// an input signal, that is sampled at 16000 S/s can be
// interpolated to 32000/s.  We want to limit the bandwidth of
...
// Transition Band: 3400 < F <= 12600 Hz.
// Stop Band: 12600 < F < 16000 Hz.
...
title("Antialiasing Filter - Sample Rate: 32000 S/s  (interpolated)");
a = gca();
