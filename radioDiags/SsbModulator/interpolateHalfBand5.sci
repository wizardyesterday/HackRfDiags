...
// an input signal, that is sampled at 256000 S/s can be
// interpolated to 512000S/s.  We want to limit the bandwidth of
...
// Transition Band: 27200 < F <= 228800 Hz.
// Stop Band: 228800 < F < 256000 Hz.
...
title("Antialiasing Filter - Sample Rate: 512000 S/s  (interpolated)");
a = gca();
