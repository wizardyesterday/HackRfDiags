...
// an input signal, that is sampled at 1024000 S/s can be
// interpolated to 2048000 S/s.  We want to limit the bandwidth of
...
// Transition Band: 27200 < F <= 992080 Hz.
// Stop Band: 992080 < F < 1024000 Hz.
...
title("Antialiasing Filter - Sample Rate: 2048000 S/s  (interpolated)");
a = gca();
